...
4. Resolve variables, inherited auth, and auth/runtime mappings.
5. Refresh or acquire required OAuth2 material and propagate configured environment outputs.
6. Build the final HTTP request.
7. Send the request.
8. Run post-response and test scripts.
9. Merge supported persisted mutations.
10. Update Workbench/Runner details, History, and Diagnostics.
### 4.3 Runner Flow
